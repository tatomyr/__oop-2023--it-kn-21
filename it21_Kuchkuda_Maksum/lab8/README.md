...
### Хід роботи
1. Пишемо нас основний клас і декілька дочірних в [файлі](./creating_subclasses.py).
...
### Висновок
На практичній роботі ми оволоділи концепцією наслідування класів. Вивчили методи *i​nstanceof, issubclassof*. Засвоїли метод *super*.