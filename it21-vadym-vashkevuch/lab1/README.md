...
2. Створюємо власну гілку з назвою **it21-vadym-vashkevuch**
3. Створюємо [пайтон програму](./main.py) з базовим класом
4. Пушимо наші зміни на **Github** за допомогою команди `git push origin it21-vadym-vashkevuch`
