...
### Хід роботи
1. Створюємо клас *Dog* з атрибутами імені, віку, породи та власника у [нашому файлі](./main.py).
2. Реалізуємо методи для отримання віку, зміни віку, можливості собаці гавкати та зміни власника.
3. Знайомимось з поняттям змінної класу. Реалізовуємо метод *bark*, який її використовує.
